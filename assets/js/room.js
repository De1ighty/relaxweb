...
import { displayNameOf, elements, formatCoins, isRoomOwner, ratingBadge, renderGameView, send, setRoomMode, state, stopHallTicker, updateCoinChip } from "./core.js";
...
function seatNodeByIndex(index) {
  // 座位 DOM 由各游戏模块自己认领（扑克 .poker-seats / .uno-seats）
...
function renderHandResultOverlay() {
  const info = state.myRoom?.hand_ready;
